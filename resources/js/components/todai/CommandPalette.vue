...
import { CalendarDays, FolderKanban, Inbox, MessageSquare, Search } from '@lucide/vue';
...
const baseCommands = computed<Command[]>(() => [
    { id: 'vandaag', label: 'Vandaag', icon: CalendarDays, url: '/' },
    { id: 'inbox', label: 'Inbox', icon: Inbox, url: '/inbox' },
    { id: 'projecten', label: 'Projecten', icon: FolderKanban, url: ProjectController.index().url },
        ...
        <DialogContent class="gap-0 p-0 sm:max-w-lg" :show-close-button="false">
            <div class="flex items-center gap-2 border-b border-border px-4">
                ...
                <input
                    ...
                    v-model="search"
                    type="text"
                    placeholder="Zoek of spring naar..."
